...
class NumbersProxyFeature extends NumbersBaseFeature
{
    ...
    public function init(NumbersContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NumbersContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
