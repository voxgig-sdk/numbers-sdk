...
// Numbers SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NumbersTestFeature extends NumbersBaseFeature
{
    ...
    public function init(NumbersContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NumbersContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NumbersContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NumbersContext $ctx, $op, $args): array
    {
