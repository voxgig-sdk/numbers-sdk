...
class NumbersStreamingFeature extends NumbersBaseFeature
{
    ...
    private function _iterate(NumbersResult $result): \Generator
    {
    ...
    private function _streamable(NumbersContext $ctx): bool
    {
