...
The PHP SDK for the Numbers API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetNumberFact(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Numbers(null)->load(
    ["id" => "test01"], null
);
