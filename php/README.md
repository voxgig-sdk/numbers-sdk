...
The PHP SDK for the Numbers API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($getnumberfact->data_get());
} catch (\Throwable $err) {
...
print_r($getnumbertrivia->data_get());
```
...
```
php/
├── numbers_sdk.php          -- Main SDK class
...
The main class (`numbers_sdk.php`) exports the SDK class
