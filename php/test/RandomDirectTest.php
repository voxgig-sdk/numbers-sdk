...
{
    public function test_direct_load_random(): void
    {
        $setup = random_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-random", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
