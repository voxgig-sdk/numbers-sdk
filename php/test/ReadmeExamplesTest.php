...
// Numbers SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NumbersSDK::test)
...
{
    private const SDK_CLASS = 'NumbersSDK';
    ...
    private const SDK_BASE = 'numbers_sdk';
