...
class NumbersTestRunner
{
    ...
    {
        $live = self::getenv('NUMBERS_TEST_LIVE');
        $override = self::getenv('NUMBERS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NUMBERS_TEST_EXPLAIN');
...
class_alias('NumbersTestRunner', 'Runner');
class_alias('NumbersHelpers', 'Helpers');
