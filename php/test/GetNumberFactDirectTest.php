...
class GetNumberFactDirectTest extends TestCase
{
    public function test_direct_load_get_number_fact(): void
    {
        $setup = get_number_fact_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_number_fact", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function get_number_fact_direct_setup($mockres)
{
