...
class RandomEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NUMBERS_TEST_RANDOM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function random_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NUMBERS_TEST_RANDOM_ENTID");
