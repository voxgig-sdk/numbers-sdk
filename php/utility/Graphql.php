...
class NumbersGraphql
{
    ...
    // equivalent.
    public static function body(NumbersContext $ctx): mixed
    {
    ...
    public static function errors(NumbersContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
