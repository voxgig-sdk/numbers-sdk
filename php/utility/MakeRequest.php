...
// Numbers SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NumbersMakeRequest
{
    public static function call(NumbersContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NumbersResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NumbersResponse($fetched);
        } else {
