...
class GetNumberTriviaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetNumberTriviaEntity($this->_client, $opts);
    }

    /**
     * @param GetNumberTrivia|array $args GetNumberTrivia data (assoc-array) to store.
     */
    ...
    /**
     * @return GetNumberTrivia|array The current GetNumberTrivia data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetNumberTrivia fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetNumberTrivia fields).
     */
    ...
    /**
     * Load a single GetNumberTrivia.
     *
     * @param GetNumberTriviaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetNumberTriviaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetNumberTrivia|array The loaded GetNumberTrivia as an assoc-array at the
