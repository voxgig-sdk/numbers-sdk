...
describe('exists', async () => {
  ...
  //
  // NumbersSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof NumbersSDK, true,
      'NumbersSDK.test() must return a client synchronously')
  })
