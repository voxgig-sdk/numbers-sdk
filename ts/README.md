# Numbers TypeScript SDK

The TypeScript SDK for the Numbers API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `NumbersSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `NumbersSDK.test(testopts?, sdkopts?)` | `NumbersSDK` | Create a test-mode client. |
