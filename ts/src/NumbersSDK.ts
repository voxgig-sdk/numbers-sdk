...
class NumbersSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('NumbersSDK: graphql: ' +
  ...
  GetNumberFact(entopts?: Record<string, any>) {
    const self = this
    return new GetNumberFactEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetNumberTrivia(entopts?: Record<string, any>) {
    const self = this
    return new GetNumberTriviaEntity(self, entopts)
  }
