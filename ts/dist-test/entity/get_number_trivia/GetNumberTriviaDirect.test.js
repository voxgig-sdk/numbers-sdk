...
(0, node_test_1.describe)('GetNumberTriviaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_number_trivia', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_number_trivia', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NUMBERS_TEST_GET_NUMBER_TRIVIA_ENTID'];
...
//# sourceMappingURL=GetNumberTriviaDirect.test.js.map