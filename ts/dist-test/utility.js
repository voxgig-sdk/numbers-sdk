...
function envOverride(m) {
    if ('TRUE' === process.env.NUMBERS_TEST_LIVE ||
        'TRUE' === process.env.NUMBERS_TEST_OVERRIDE) {
    ...
    m.NUMBERS_TEST_EXPLAIN = process.env.NUMBERS_TEST_EXPLAIN || m.NUMBERS_TEST_EXPLAIN;
    return m;
}
