...
module NumbersTestRunner
  ...
  def self.env_override(m)
    live = getenv("NUMBERS_TEST_LIVE")
    override = getenv("NUMBERS_TEST_OVERRIDE")
    ...
    explain = getenv("NUMBERS_TEST_EXPLAIN")
    m["NUMBERS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NumbersTestRunner
Helpers = NumbersHelpers
Vs = VoxgigStruct
