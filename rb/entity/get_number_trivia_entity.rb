...
class GetNumberTriviaEntity
  ...
  def make
    opts = @_entopts.dup
    GetNumberTriviaEntity.new(@_client, opts)
  end
  ...
  # @return [GetNumberTrivia, Hash] the current GetNumberTrivia data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetNumberTrivia fields)
  def match_get
  ...
  #
  # @param reqmatch [GetNumberTriviaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetNumberTrivia.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetNumberTrivia, Hash] the loaded GetNumberTrivia; raises NumbersError on failure
