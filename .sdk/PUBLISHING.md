...
|---|---|---|
| `ts/` | @voxgig-sdk/numbers-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/numbers-sdk \
      --repository voxgig-sdk/numbers-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/numbers-sdk` shows it, and
`npm trust revoke @voxgig-sdk/numbers-sdk --id=<id>` removes it.
