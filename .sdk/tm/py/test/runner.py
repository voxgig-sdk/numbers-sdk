...
class NumbersTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NumbersTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NumbersTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NumbersTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
