...
class NumbersTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NumbersTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NumbersTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NumbersTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
