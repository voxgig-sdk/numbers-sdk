...
from projectname_sdk import NumbersSDK
from projectname_sdk.core.spec import NumbersSpec
from projectname_sdk.core.result import NumbersResult
from projectname_sdk.core.response import NumbersResponse
from projectname_sdk.core.operation import NumbersOperation
from projectname_sdk.core.error import NumbersError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import NumbersBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = NumbersSDK.test(None, None)
        ...
        class TestInitFeature(NumbersBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(NumbersBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = NumbersSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = NumbersSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = NumbersSDK.test(None, setup_opts)
