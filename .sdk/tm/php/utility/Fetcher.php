...
// Numbers SDK utility: fetcher

class NumbersFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NumbersSDK/1.0)';
    ...
    public static function call(NumbersContext $ctx, string $fullurl, array $fetchdef): array
    {
