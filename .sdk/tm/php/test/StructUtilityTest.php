...
// Numbers SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NumbersOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NumbersOmni::structfix($now, Struct::undef()))
                        !== json_encode(NumbersOmni::structfix($val, Struct::undef()))) {
