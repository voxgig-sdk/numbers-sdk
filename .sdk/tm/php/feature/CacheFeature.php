...
class NumbersCacheFeature extends NumbersBaseFeature
{
    ...
    private function _through(NumbersContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
