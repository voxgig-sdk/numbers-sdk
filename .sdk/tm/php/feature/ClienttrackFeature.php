...
// Numbers SDK clienttrack feature
...
class NumbersClienttrackFeature extends NumbersBaseFeature
{
    ...
    public function PostConstruct(NumbersContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Numbers-SDK';
