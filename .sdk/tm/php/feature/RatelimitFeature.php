...
class NumbersRatelimitFeature extends NumbersBaseFeature
{
    ...
    private function _acquire(NumbersContext $ctx): void
    {
    ...
    private function _track(NumbersContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
