...
class NumbersTimeoutFeature extends NumbersBaseFeature
{
    ...
    private function _with_timeout(NumbersContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NumbersContext $_ctx, float $ms): void
    {
        $client = $this->client;
