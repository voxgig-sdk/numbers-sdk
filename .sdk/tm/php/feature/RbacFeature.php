...
class NumbersRbacFeature extends NumbersBaseFeature
{
    ...
    private function _required(NumbersContext $ctx): ?string
    {
    ...
    private function _reject(NumbersContext $ctx, string $required): void
    {
    ...
    private function _track(NumbersContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
