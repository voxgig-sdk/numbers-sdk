...
class NumbersNetsimFeature extends NumbersBaseFeature
{
    ...
    private function _simulate(NumbersContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NumbersContext $ctx, array $applied): void
    {
        $client = $this->client;
