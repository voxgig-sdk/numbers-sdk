# Numbers SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NumbersSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NumbersSDK(...) and NumbersSDK.test(...) become
#      NumbersSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "numbers_sdk"
_SDK_CLASS = "NumbersSDK"
...
_ENTITIES = {
    "GetNumberFact": "get_number_fact",
    "GetNumberTrivia": "get_number_trivia",
    "Random": "random",
}
