...
class GetNumberTriviaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetNumberTriviaEntity(self._client, opts)
    ...
    def data_get(self) -> GetNumberTrivia:
    ...
    def match_get(self) -> GetNumberTrivia:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetNumberTrivia:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetNumberTrivia().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
