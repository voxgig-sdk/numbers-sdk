...
from numbers_sdk.numbers_types import (
    GetNumberFact,
...
class GetNumberFactEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetNumberFactEntity(self._client, opts)
    ...
    def data_get(self) -> GetNumberFact:
    ...
    def match_get(self) -> GetNumberFact:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetNumberFact:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetNumberFact().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
