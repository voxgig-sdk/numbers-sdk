...
from numbers_sdk.utility import register

# Load features
from numbers_sdk.feature.base_feature import NumbersBaseFeature
from numbers_sdk.features import _has_feature, _make_feature
...
class NumbersSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NumbersUtility()
        self._utility = utility

        from numbers_sdk.config import shared_config
    ...
    def get_utility(self):
        return NumbersUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NumbersSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetNumberFact(self, data=None) -> "GetNumberFactEntity":
        ...
        from numbers_sdk.entity.get_number_fact_entity import GetNumberFactEntity
    ...
    def GetNumberTrivia(self, data=None) -> "GetNumberTriviaEntity":
        ...
        from numbers_sdk.entity.get_number_trivia_entity import GetNumberTriviaEntity
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from numbers_sdk.entity.random_entity import RandomEntity
