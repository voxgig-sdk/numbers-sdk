# Numbers Golang SDK Reference

Complete API reference for the Numbers Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *NumbersSDK`
...
#### `GetNumberFact(data map[string]any) NumbersEntity`

Create a new `GetNumberFact` entity instance. Pass `nil` for no initial data.

#### `GetNumberTrivia(data map[string]any) NumbersEntity`

Create a new `GetNumberTrivia` entity instance. Pass `nil` for no initial data.

#### `Random(data map[string]any) NumbersEntity`
