...
const testSeed = `map[string]any{"entity": map[string]any{"get_number_fact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_number_trivia": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
