...
func (sdk *NumbersSDK) OptionsMap() map[string]any {
...
func (sdk *NumbersSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NumbersSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NumbersSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NumbersSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NumbersSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NumbersSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NumbersSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NumbersSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NumbersSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NumbersSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
