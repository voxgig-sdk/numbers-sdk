...
type GetNumberTriviaEntity struct {
	name    string
	client  *core.NumbersSDK
...
func NewGetNumberTriviaEntity(client *core.NumbersSDK, entopts map[string]any) *GetNumberTriviaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetNumberTriviaEntity) GetName() string { return e.name }
...
func (e *GetNumberTriviaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetNumberTriviaEntity) Deleted() bool {
	return e.deleted
}


func (e *GetNumberTriviaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetNumberTriviaEntity(e.client, opts)
}

func (e *GetNumberTriviaEntity) Data(args ...any) any {
...
func (e *GetNumberTriviaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetNumberTrivia; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetNumberTriviaEntity) DataTyped(data ...GetNumberTrivia) GetNumberTrivia {
	if len(data) > 0 {
		return typedFrom[GetNumberTrivia](e.Data(asMap(data[0])))
	}
	return typedFrom[GetNumberTrivia](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetNumberTrivia (all fields
// optional at the wire level).
func (e *GetNumberTriviaEntity) MatchTyped(match ...GetNumberTrivia) GetNumberTrivia {
	if len(match) > 0 {
		return typedFrom[GetNumberTrivia](e.Match(asMap(match[0])))
	}
	return typedFrom[GetNumberTrivia](e.Match())
}
...
func (e *GetNumberTriviaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetNumberTriviaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetNumberTriviaLoadMatch and returns an GetNumberTrivia. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetNumberTriviaEntity) LoadTyped(reqmatch GetNumberTriviaLoadMatch, ctrl map[string]any) (GetNumberTrivia, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetNumberTrivia{}, err
	}
	return typedFrom[GetNumberTrivia](res), nil
}



func (e *GetNumberTriviaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetNumberTriviaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetNumberTriviaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetNumberTriviaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetNumberTriviaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
