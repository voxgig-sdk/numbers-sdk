...
type GetNumberFactEntity struct {
	name    string
...
func NewGetNumberFactEntity(client *core.NumbersSDK, entopts map[string]any) *GetNumberFactEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetNumberFactEntity) GetName() string { return e.name }
...
func (e *GetNumberFactEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetNumberFactEntity) Deleted() bool {
	return e.deleted
}


func (e *GetNumberFactEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetNumberFactEntity(e.client, opts)
}

func (e *GetNumberFactEntity) Data(args ...any) any {
...
func (e *GetNumberFactEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetNumberFact; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetNumberFactEntity) DataTyped(data ...GetNumberFact) GetNumberFact {
	if len(data) > 0 {
		return typedFrom[GetNumberFact](e.Data(asMap(data[0])))
	}
	return typedFrom[GetNumberFact](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetNumberFact (all fields
// optional at the wire level).
func (e *GetNumberFactEntity) MatchTyped(match ...GetNumberFact) GetNumberFact {
	if len(match) > 0 {
		return typedFrom[GetNumberFact](e.Match(asMap(match[0])))
	}
	return typedFrom[GetNumberFact](e.Match())
}
...
func (e *GetNumberFactEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetNumberFactEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetNumberFactLoadMatch and returns an GetNumberFact. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetNumberFactEntity) LoadTyped(reqmatch GetNumberFactLoadMatch, ctrl map[string]any) (GetNumberFact, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetNumberFact{}, err
	}
	return typedFrom[GetNumberFact](res), nil
}



func (e *GetNumberFactEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetNumberFactEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetNumberFactEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetNumberFactEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetNumberFactEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
