...
AQL-driven CLI and REPL for the Numbers SDK. Positional arguments are
...
./numbers-cli list get_number_fact
./numbers-cli load 1 get_number_fact
./numbers-cli load '{id:1}' get_number_fact
