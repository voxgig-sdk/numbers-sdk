...
func registerSDKWords(r *eng.Registry, client *sdk.NumbersSDK) {
...
func runOp(client *sdk.NumbersSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
