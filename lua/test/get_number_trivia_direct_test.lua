...
describe("GetNumberTriviaDirect", function()
  it("should direct-load-get_number_trivia", function()
    local setup = get_number_trivia_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_number_trivia", setup.live and "live" or "unit")
