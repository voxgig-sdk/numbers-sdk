...
describe("GetNumberFactDirect", function()
  it("should direct-load-get_number_fact", function()
    local setup = get_number_fact_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_number_fact", setup.live and "live" or "unit")
