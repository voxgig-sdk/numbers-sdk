...
local GetNumberFactEntity = {}
GetNumberFactEntity.__index = GetNumberFactEntity


function GetNumberFactEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetNumberFactEntity)
  self._name = "get_number_fact"
  self._client = client
...
function GetNumberFactEntity:get_name()
  return self._name
end


function GetNumberFactEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetNumberFactEntity.new(self._client, opts)
end
...
function GetNumberFactEntity:mark_deleted()
  self._deleted = true
end


function GetNumberFactEntity:deleted()
  return true == self._deleted
end


function GetNumberFactEntity:data_set(args)
  if args ~= nil then
...
function GetNumberFactEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetNumberFactEntity:match_set(args)
  if args ~= nil then
...
function GetNumberFactEntity:match_get()
...
function GetNumberFactEntity:stream(action, args, callopts)
...
---@param reqmatch GetNumberFactLoadMatch
---@param ctrl? table
---@return GetNumberFact
---@return string? err
function GetNumberFactEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetNumberFactEntity:_run_op(ctx, post_done)
  local utility = self._utility
