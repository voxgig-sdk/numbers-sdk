...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/numbers` | `npm install @voxgig-sdk/numbers` |
| Python | `voxgig-sdk-numbers` | `pip install voxgig-sdk-numbers` |
| PHP | `voxgig-sdk/numbers` | `composer require voxgig-sdk/numbers` |
| Golang | `github.com/voxgig-sdk/numbers-sdk/go` | `go get github.com/voxgig-sdk/numbers-sdk/go` |
| Ruby | `voxgig-sdk-numbers` | `gem install voxgig-sdk-numbers` |
| Lua | `voxgig-sdk-numbers` | `luarocks install voxgig-sdk-numbers` |
